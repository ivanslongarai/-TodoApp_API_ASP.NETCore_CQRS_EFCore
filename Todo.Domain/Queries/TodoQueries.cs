...
public static class TodoQueries
{
    ...
    public static Expression<Func<TodoItem, bool>> GetByDate(string user, DateTime executionDate, bool done)
    {
        return x => x.User == user && x.Done == done && x.ExecutionDate.Date == executionDate.Date;
    }
}